...
class WindBleStatusScreen extends StatefulWidget {
  const WindBleStatusScreen({required this.status, Key? key}) : super(key: key);

  final BleStatus status;

  @override
  State<WindBleStatusScreen> createState() => _BleStatusScreenState();
}

class _BleStatusScreenState extends State<WindBleStatusScreen> with SingleTickerProviderStateMixin {
