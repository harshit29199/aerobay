...
class PlaneDeviceListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Consumer4<BleScanner, BleScannerState,BleDeviceConnector,ConnectionStateUpdate>(
    builder: (_, bleScanner, bleScannerState,deviceConnector, connectionStateUpdate,__) => PlaneScanPage(
...
class PlaneScanPage extends StatefulWidget {
  const PlaneScanPage({required this.scannerState, required this.startScan, required this.stopScan,required this.deviceConnector,required this.connectionStatus});
  ...
  @override
  State<PlaneScanPage> createState() => _PlaneScanPageState();
}

class _PlaneScanPageState extends State<PlaneScanPage> {
