...
class CarBleStatusScreen extends StatefulWidget {
  const CarBleStatusScreen({required this.status, Key? key}) : super(key: key);

  final BleStatus status;

  @override
  State<CarBleStatusScreen> createState() => _BleStatusScreenState();
}

class _BleStatusScreenState extends State<CarBleStatusScreen> with SingleTickerProviderStateMixin {
