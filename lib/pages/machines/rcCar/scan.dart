...
class CarDeviceListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Consumer4<BleScanner, BleScannerState,BleDeviceConnector,ConnectionStateUpdate>(
    builder: (_, bleScanner, bleScannerState,deviceConnector, connectionStateUpdate,__) => CarScanPage(
...
class CarScanPage extends StatefulWidget {
  const CarScanPage({required this.scannerState, required this.startScan, required this.stopScan,required this.deviceConnector,required this.connectionStatus});
  ...
  @override
  State<CarScanPage> createState() => _CarScanPageState();
}

class _CarScanPageState extends State<CarScanPage> {
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          margin: const EdgeInsets.symmetric(
                              vertical: 10.0,
                              horizontal: 25), // Spacing between tiles
                          decoration: BoxDecoration(
                            border: Border.all(
                                color: Colors.white, width: 1), // White border
                            borderRadius: BorderRadius.circular(
                                12.0), // Rounded border for each tile
                          ),
                          child: ListTile(
                            minTileHeight: 11,
                            leading: const Icon(
                          ...
                          *//* GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20.0),
                               border: Border.all(
                                 color: AppColor.instanse.borderWhite.withOpacity(0.3)
                               ),
