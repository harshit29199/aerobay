...
class RoverBleStatusScreen extends StatefulWidget {
  const RoverBleStatusScreen({required this.status, Key? key}) : super(key: key);

  final BleStatus status;

  @override
  State<RoverBleStatusScreen> createState() => _BleStatusScreenState();
}

class _BleStatusScreenState extends State<RoverBleStatusScreen> with SingleTickerProviderStateMixin {
