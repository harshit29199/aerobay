...
class RoverDeviceListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Consumer4<BleScanner, BleScannerState,BleDeviceConnector,ConnectionStateUpdate>(
    builder: (_, bleScanner, bleScannerState,deviceConnector, connectionStateUpdate,__) => RoverScanPage(
...
class RoverScanPage extends StatefulWidget {
  const RoverScanPage({required this.scannerState, required this.startScan, required this.stopScan,required this.deviceConnector,required this.connectionStatus});
  ...
  @override
  State<RoverScanPage> createState() => _CarScanPageState();
}

class _CarScanPageState extends State<RoverScanPage> {
