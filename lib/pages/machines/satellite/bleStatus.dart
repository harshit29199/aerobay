...
class SatelliteBleStatusScreen extends StatefulWidget {
  const SatelliteBleStatusScreen({required this.status, Key? key}) : super(key: key);

  final BleStatus status;

  @override
  State<SatelliteBleStatusScreen> createState() => _BleStatusScreenState();
}

class _BleStatusScreenState extends State<SatelliteBleStatusScreen> with SingleTickerProviderStateMixin {
