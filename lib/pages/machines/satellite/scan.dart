...
class SatelliteDeviceListScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Consumer4<BleScanner, BleScannerState,BleDeviceConnector,ConnectionStateUpdate>(
    builder: (_, bleScanner, bleScannerState,deviceConnector, connectionStateUpdate,__) => SatelliteScanPage(
...
class SatelliteScanPage extends StatefulWidget {
  const SatelliteScanPage({required this.scannerState, required this.startScan, required this.stopScan,required this.deviceConnector,required this.connectionStatus});
  ...
  @override
  State<SatelliteScanPage> createState() => _CarScanPageState();
}

class _CarScanPageState extends State<SatelliteScanPage> {
